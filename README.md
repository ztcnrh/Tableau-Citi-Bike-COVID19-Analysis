...
***Hypothetical scenario:** NYC city officials would like to understand how Citi Bikes were utilized during the COVID-19 pandemic and if there's a lesson to be learned from the user behavior. Questions they might have in mind include but are not limited to: Were bikes rented more often during the pandemic? What were the characteristics of the typical users? From which stations were the bikes rented the most? Were there insights to be gained relating all of these to the control of COVID-19 outbreak? And so on... From there, initiatives can be taken and programs can be implemented by the city planning department and Citi Bike working hand in hand to promote a safer use of the transportation innovation while continue to provide the convenience to the public.*
